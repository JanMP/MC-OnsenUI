...
.text-container
  ...
  markdown.
    ...
    * Der Programmcode wird für mich übersichtlicher und langfristig besser wartbar.
    ...
    Das neue MatheCoach läuft auf einem eigenen Server, greift aber auf die gleiche Datenbank zu, wie die alte Version. Das bedeutet, dass Ihr euch auf der neuen Version direkt mit eurem alten Benutzeraccount einloggen könnt und alle Aufgaben und Punkte mit der alten Version synchronisert werden.

    Solange die neue Version noch nicht den vollen Funktionsumfang hat, könnt Ihr also beide Versionen nebeneinander benutzen.
</template>
